...
- 🤖 **AI валидация** - автоматическая проверка качества данных (Gemini/GPT)
- 📊 **Умная фильтрация** - цена, площадь, расположение, тип недвижимости
- ✅ **Reality Check** - AI проверяет реалистичность цен и параметров
...
### AI Валидация (Рекомендуется!)

```bash
# 1. Получите бесплатный API ключ от Google Gemini
# https://makersuite.google.com/app/apikey

# 2. Добавьте в .env файл
cp .env.example .env
nano .env
# Установите: GEMINI_API_KEY=ваш_ключ

# 3. Анализируйте с AI валидацией
npm run aggregator:analyze https://example.bg --name "Example" --ai --save

# AI автоматически проверит:
# ✅ Качество селекторов
# ✅ Корректность данных
# ✅ Реалистичность цен для Софии
...
- **[AI_VALIDATION_GUIDE.md](./AI_VALIDATION_GUIDE.md)** - Руководство по AI валидации 🤖
